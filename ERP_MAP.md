...
| `/documentos` Comprobantes | `apps/web/app/(dashboard)/documentos/page.tsx` | `ConfirmDialog`, `printDocumentA4` | Historial, filtros, vista partida lista/detalle en PC, detalle sheet en mobile, confirmar/anular/convertir, imprimir y CSV. | Completo, crítico | Documents, Payments, Cash, Stock, CurrentAccount, DocumentConversion. | Muy alto: confirmar/anular afecta stock, caja y deuda. |
